        ...
        <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <div class="shrink-0 flex"> 
                                <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                    {{-- <div>{{ __('Письма') }}</div> --}}
                                    <x-nav-link :active="request()->routeIs('messages.index')">
                                        {{ __('Письма') }}
                                    </x-nav-link>                               
                                    <div class="ms-1">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('outbox')">
                                {{ __('Исходящие') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <div class="shrink-0 flex"> 
                        <img width="32" height="32" class="rounded-circle" src="{{ asset("storage/photos/avatar.png")}}"  alt="..." />
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
